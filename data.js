...
const GRAMMAR = [
  ...
  },
  {
    ...
    body:
      ...
      `예) something <b>to eat</b>(먹을 것) · a chance <b>to win</b>(이길 기회) · the best <b>way</b> <u>to learn</u>(배우는 최고의 방법)<br>🚨 ability <u>of performing</u> ❌ → ability <b>to perform</b>` +
      `</div>` +
...
/* ---------- 출석 플랜 ----------
   📅 출석 탭의 완주 목표. 날짜·문장 수만 바꾸면 계산(예정선·남은 하루 필요량)이 따라옵니다.
   target = 플랜 시작일 기준 아직 분석 안 한 문장 수 (지문2 끝 4문장 + 지문4~8 212문장) */
const STUDY_PLAN = {
  start:  "2026-09-25",
  end:    "2026-10-31",
  daily:  7,
