...
const WORDS_BY_PASSAGE = {
  ...
  { word: "differentiate",    pos: "v.",   meaning: "구별하다, 구분 짓다 (differentiate A from B)", example: "characteristics that differentiate them from others" },
  ...
  { word: "clear",            pos: "v.",   meaning: "없애다, 제거하다; 치우다 (clear A from B)", example: "clear the lactate from their muscles" },
